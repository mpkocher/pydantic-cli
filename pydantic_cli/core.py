...
# A bit of boilerplate to get around the class style mixin model.
class DefaultConfig:
    """
    ...
    # Set the model namespace in the JSON
    # Default flag for
    CLI_JSON_NS_FLAG: str = "json-ns"
    CLI_JSON_NS_ENV_VAR = "PCLI_JSON_NS"
    CLI_JSON_NS: T.Optional[str] = None
...
class CliConfig(BaseModel):
    ...
    # JSON Model Namespace
    # None means use the Root namespace
    js_config_namespace: T.Optional[str] = DefaultConfig.CLI_JSON_NS
    js_config_namespace_flag: str = DefaultConfig.CLI_JSON_NS_FLAG
    js_config_namespace_env_var: str = DefaultConfig.CLI_JSON_NS_ENV_VAR
...
def _get_cli_config_from_model(cls: T.Type[M]) -> CliConfig:
    ...
    # Namespace
    js_config_ns_flag: str = getattr(
        cls.Config, "CLI_JSON_NS_FLAG", DefaultConfig.CLI_JSON_NS_FLAG
    )
    js_config_ns: T.Optional[str] = getattr(
        cls.Config, "CLI_JSON_NS", DefaultConfig.CLI_JSON_NS
    )
    js_config_ns_env_var: str = getattr(
        cls.Config, "CLI_JSON_NS_ENV_VAR", DefaultConfig.CLI_JSON_CONFIG_ENV_VAR
    )
    ...
    path: T.Optional[str] = os.environ.get(js_config_env_var, js_config_path)
    ...
    shell_completion_enable: bool = getattr(
        cls.Config,
    ...
    return CliConfig(
        json_config_enable=enable_js_config,
        json_config_key=js_key_field_name,
        json_config_env_var=js_config_env_var,
        json_config_path=path,
        json_config_path_validate=js_config_validate_path,
        js_config_namespace_flag=js_config_ns_flag,
        js_config_namespace=js_config_ns,
        js_config_namespace_env_var=js_config_ns_env_var,
        bool_prefix=custom_bool_prefix,
        custom_opts=custom_opts,
        shell_completion_enable=shell_completion_enable,
